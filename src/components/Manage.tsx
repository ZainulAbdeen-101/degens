  ...
  return (
    <>
      ...
      <div className="flex justify-center mt-20">
        <progress
          className=" progress progress-warning w-[1000px]"
          value="30"
          max="100"
        ></progress>
      </div>
      <div className="flex mt-10  items-center justify-center gap-32">
        <div className="flex items-center gap-5 ">
          <input
            type="checkbox"
            defaultChecked={true}
            className="checkbox bg-[#FF3969] checkbox-xs"
          />
      ...
      <div className="flex justify-center mt-20 ">
        <Image
          className="backdrop-filter  p-8  bg-white/10   backdrop-blur-md drop-shadow-lg border-t border-r border-l border-[white]  rounded-3xl"
          src={"/screen.png"}
          width={800}
          height={800}
          alt=""
